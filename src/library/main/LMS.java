...
public class LMS {
    ...
    public static void main(String[] args)
    {
        ...
        while(true)
        {
            ...
            switch(choice)
            {
                case 1 : addBook(scanner,bookManager); break;
                case 2 : addPatron(scanner,patronManager); break;
                case 3 : displayAvailableBooks(inventoryManager); break;
                case 4 : displayBorrowedBooks(inventoryManager); break;
                case 5 : checkoutBook(scanner,lendingManager,patronManager,bookManager); break;
                case 6 : returnBook(scanner,lendingManager,patronManager,bookManager); break;
                case 7 :
